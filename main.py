...
from auth.security import login, check_auth

st.set_page_config(page_title="HR Projects & Inno", page_icon="📈", layout="wide")
...
if not st.session_state['logged_in']:
    ...
    st.write("Utilize o menu lateral para navegar entre Dashboard, Projetos e Kanban.")
